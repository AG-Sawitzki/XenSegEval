#!/bin/bash
#
#SBATCH --job-name=transcript_splitting
#SBATCH --wait
#SBATCH --time=2-00
#SBATCH --mem=64G
#SBATCH --cpus-per-task=24
#SBATCH --output=~/Juno/TMA2/run/logs/transcript_splitting_%N_%j.out
#SBATCH --error=~/Juno/TMA2/run/logs/transcript_splitting_%N_%j.err
